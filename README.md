...
- Whisper API limit 25MB per upload. Untuk audio panjang otomatis di-split jadi chunk 10 menit lalu timestamp di-offset waktu merge — `src/lib/transcribe.ts`.
